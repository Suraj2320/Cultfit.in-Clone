  ...
  return (
    <>
      <div className="cart-body">
        <h3 style={{fontSize:"20px",fontWeigth:"600",marginLeft:"650px",marginTop:"50px"}}>Your Cart</h3>
        <h1 style={{fontSize:"28px",fontWeigth:"600",marginLeft:"630px"}}>cultsport</h1>
        <hr />
                ...
                <h1 style={{fontSize:"17px",fontWeight:"500",marginRight:"250px"}}>Cultgear Order Summary</h1>
                 ...
                 {cartDetails?.map((el)=>(
                    <Box key={el.id} w='45%'  h='200px' width='90%' m="auto" marginBottom='15px' display='flex' justifyContent='space-between'  >
                       <Box  w='35%' h='100%'><Image h='100%' src={el.image} /></Box>
                       <Box  w='60%'  h='100%' display='flex' flexDirection='column' justifyContent="space-evenly"> 
                       <h1 style={{fontWeight:"600",fontSize:"20px",marginRight:"150px"}}>{el.title}</h1>
                       <h3 style={{marginRight:"180px"}}>{el.category}</h3>
                       <Box display='flex' justifyContent='space-around'>
                        <p style={{marginRight:"150px"}}>Price: ₹{el.price}</p>
                         <Box display='flex'>
                            ...
                            <span style={{border:"1px solid black",height:"28px",width:"18px",marginLeft:"0px"}} >{el.count}</span>
